...
:root {
    ...
    --tablet-page-width: min(1180px, calc(100vw - 56px));
}
...
.mobile-page::before {
    ...
    position: fixed;
    inset: 0;
    width: min(100%, var(--mobile-page-width));
    margin: 0 auto;
    pointer-events: none;
    background:
...
@media (min-width: 900px) and (orientation: landscape) {
    ...
    .healing-bottom-nav {
        width: min(760px, calc(var(--tablet-page-width) - 64px)) !important;
    ...
    .healing-bottom-nav.healing-bottom-nav-light {
        border-color: rgba(38,70,52,0.12) !important;
    }

    .healing-bottom-nav .q-column {
